...
|9              |[(Mobile) Анализ результатов маркетинговых мероприятий для продвижения мобильного приложения](ссылка)| Необходимо проанализировать результаты маркетинговых мероприятий в отношении развлекательного приложения | Python, Pandas, Matplotlib, Seaborn, Business metrics|
